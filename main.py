...
class Bank:
    ...
    def deposite_money(self):
        accno = input("tell your account no:--")
    ...
    def update_details(self):
          ...
          if userdata == False:
              ...
              newdata = {
                  ...
                  "email" : input("tell you new email or press enter to skip"),
              ...
              if newdata['pin '] == "":
                  userdata['pin'] = str(userdata[0]['pin'])
...
while True:
    ...
    print("press 3 for withdraeing oney" )
    print("press 4 for details of user")
